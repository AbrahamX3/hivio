...
export type scalarAssignableBy<T extends $.ScalarType> =
  ...
  T extends _default.$TitleType ? _default.$TitleType : 
  T extends _default.$TitleStatus ? _default.$TitleStatus : 
...
type getSharedParentScalar<A, B> =
  ...
  A extends _extauth.$FlowType ?
    ...
    never
  :
  A extends _default.$TitleType ?
    B extends _default.$TitleType ?
    B
    :
    never
  :
  A extends _default.$TitleStatus ?
    B extends _default.$TitleStatus ?
    B
    :
    never
  :
...
function getSharedParentScalar<A extends $.ScalarType, B extends $.ScalarType>(a: A, b: B): A | B {
  ...
  if (a.__name__ === "default::TitleType") {
    if(b.__name__ === "default::TitleType") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "default::TitleStatus") {
    if(b.__name__ === "default::TitleStatus") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
