...
export namespace $default {
  ...
  export interface List extends std.$Object {
    "createdBy": User;
    "title": Title;
    "createdAt": Date;
    "rating"?: number | null;
  ...
  export interface Title extends std.$Object {
    "genres": number[];
    "createdAt": Date;
  ...
  export type TitleStatus = "UPCOMING" | "PENDING" | "WATCHING" | "UNFINISHED" | "FINISHED";
  export type TitleType = "MOVIE" | "SERIES";
}
import User = $default.User;
import CurrentUser = $default.CurrentUser;
import List = $default.List;
import Title = $default.Title;
import TitleStatus = $default.TitleStatus;
import TitleType = $default.TitleType;
export type {
  User,
  CurrentUser,
  List,
...
export interface types {
  ...
  "default": {
    ...
    "List": $default.List;
    "Title": $default.Title;
    "TitleStatus": $default.TitleStatus;
    "TitleType": $default.TitleType;
  };
  "ext": {
    "auth": {
