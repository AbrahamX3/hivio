...
>(({ className, wrapperClassName, ...props }, ref) => (
	<div
		className={cn(
			"scrollbar scrollbar-track-muted scrollbar-thumb-foreground scrollbar-thumb-rounded-md scrollbar-h-2 w-full overflow-auto selection:bg-gray-600 selection:text-white",
			wrapperClassName,
		)}
	>
		<table
