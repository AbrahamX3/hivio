...
>(({ className, ...props }, ref) => {
	return (
		<div
			...
			className={cn(
				"scrollbar scrollbar-track-muted scrollbar-thumb-foreground scrollbar-track-rounded-md scrollbar-thumb-rounded-md scrollbar-w-2 flex min-h-0 flex-1 flex-col gap-2 overflow-auto group-data-[collapsible=icon]:overflow-hidden",
				className,
			)}
			{...props}
		/>
