...
import {
	getProfileAction,
	getProfileMetadataInfoAction,
} from "@/actions/profiles/user/actions";
import type {
	UserHiveProfile,
	UserHiveProfiles,
} from "@/actions/profiles/user/types";
import { EmptyCard } from "../../../../components/profiles/empty-card";
import StatsCards from "../../../../components/profiles/stats-cards";
import TableTabs from "../../../../components/profiles/table-tabs";
import ViewDetailsButton from "../../../../components/profiles/view-details-button";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
	...
	const data = await getProfileMetadataInfoAction({
...
export default async function PublicUserProfile({ params }: Props) {
	...
	const hive = result?.data?.data?.hive;
	...
	function calculateProgress(hive: UserHiveProfile) {
	...
	return (
		<>
			...
			<TableTabs
				currentUser={currentUser}
				data={JSON.parse(JSON.stringify(hive)) as UserHiveProfiles}
			/>
		</>
	);
}
