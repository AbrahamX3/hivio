							...
							render={({ field }) => (
								<FormItem>
									...
									>
										...
										<SelectContent>
											{titleSeasons
												.filter((season) => season.date !== null)
												.map(({ season }) => (
													<SelectItem
														key={`season_${season}`}
														value={String(season)}
				...
				<FormField
					...
					render={({ field }) => (
						<FormItem>
							...
							<FormDescription>
								0 = No Rating. It won&apos;t be visible on your public profile.
								<br />
								1-10 = Your Rating. It will be visbile on your public profile.
							</FormDescription>
							<FormMessage />
						</FormItem>
					)}
