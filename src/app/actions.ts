...
export const getMovieDetails = actionClient
	.schema(TitleDetailsSchema)
...
export const getSeriesDetails = actionClient
	.schema(TitleDetailsSchema)
	.action(async ({ parsedInput: { tmdbId } }) => {
...
export const getSeriesCredits = actionClient
	.schema(TitleDetailsSchema)
	.action(async ({ parsedInput: { tmdbId } }) => {
...
export const getMovieCredits = actionClient
	.schema(TitleDetailsSchema)
	.action(async ({ parsedInput: { tmdbId } }) => {
