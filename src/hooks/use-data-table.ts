...
/** Default: URL sync + table (same idea as tablecn / Dice UI data table). */
export function useDataTable<TData>(props: UseDataTableProps<TData>) {
	const urlState = useDataTableUrl(props);
	const {
		history: _history,
		debounceMs = DEBOUNCE_MS,
		throttleMs = THROTTLE_MS,
		clearOnDefault: _clearOnDefault,
		scroll: _scroll,
		shallow = true,
