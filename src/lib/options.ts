...
export const genreOptions = [
	...
	{ value: 18, label: "Drama", icon: DramaIcon },
	{ value: 27, label: "Horror", icon: Film },
	{ value: 28, label: "Action", icon: ActivityIcon },
	{ value: 35, label: "Comedy", icon: LaughIcon },
	...
	{ value: 10764, label: "Reality", icon: ClapperboardIcon },
	{ value: 10765, label: "Sci-Fi & Fantasy", icon: Film },
	{ value: 10766, label: "Soap", icon: Film },
	{ value: 10767, label: "Talk", icon: SpeechIcon },
